...
/set?fn=FL,FH,SL,SH,Flags - Set the fan output parameters. FL = min fan speed before "long PID" mode, FH = max fan speed, SL = Servo Low (in 10x usec), SH = Servo High (in 10x usec). Flags = Bitfield 0=Invert Fan, 1=Invert Servo, 2=Fan at max only, 3=Servo mix/max only, 4=Fan Linear Voltage, 5= Fan speed shifts when servo is high or low in range
...
$HMPS,cPidB,cPidP,cPidI,cPidD,tempsD
PID State Update
